    ...
    return (
        <div className='bg-gray-100 px-2 font-bold'>
            ...
            <div className='flex md:hidden justify-between items-center  px-4 pt-8'>
                ...
                <div className='font-extrabold text-base text-slate-600 '>{product[0].name}</div>
                ...
                <div className='flex flex-col md:flex-row'>
                    <div className='md:flex md:w-2/3'>
                        <div className='md:w-2/3'>
                            <div className='px-10'><img className='rounded-2xl shadow-xl' src={product[0].src1} /></div>
                            <div className='flex px-10 justify-around'>{product[0].src2.length && product[0].src2.map(item => <img className='w-24 rounded-xl shadow-xl my-6 ' src={item} />)}</div>
                        </div>
                        <div className='px-6 md:w-2/3'>
                            <h1 className='text-center my-4 text-xl'>{product[0].name}</h1>
                            <div>
                    ...
                    <div className='md:w-1/3 mt-5'>
                        <div className='shadow-lg bg-stone-100 rounded-2xl p-2 mb-4'>
                            ...
                            <div className='flex justify-between mt-8 items-center'>
                                <button className='bg-orange-500 text-white rounded-2xl p-3 px-6'>اضافه به سبد خرید</button>
                                <p className='text-orange-600'>{`${product[0].price} تومان`}</p>
                            </div>
                        </div>
                    </div>
                </div>
