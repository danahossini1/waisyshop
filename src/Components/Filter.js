...
export default function Filter({ openFilter, filterShow, filterAction, filterMaxPrice, filterMinPrice, setFilterMaxPrice, setFilterMinPrice, filterMark, setFilterMark }) {
    return (
        <div>
            ...
            <div className={`mr-4  ${openFilter === 'brand' ? 'block ' : 'hidden'} `}>
            ...
            <button onClick={filterAction} className='bg-blue-700 mt-8 rounded-lg shadow-2xl text-sm shadow-slate-800 px-5 text-white p-2'>اعمال فیلتر</button>
        </div>
    )
}
